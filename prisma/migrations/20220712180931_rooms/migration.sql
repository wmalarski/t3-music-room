...
CREATE TABLE "Action" (
    ...
    "likeAt" DATETIME,
    "dislikeAt" DATETIME,
    CONSTRAINT "Action_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "Message" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
-- CreateIndex
CREATE UNIQUE INDEX "Action_userId_messageId_key" ON "Action"("userId", "messageId");
